...
|-----------|----------|----------|
| Phaser scenes, UI, sprites, animations, HUD | Leah | LoginScene, ActionBar, skill VFX, inventory panel |
| Server systems, combat, mobs, networking, DB | Tyrael | CombatSystem, MobAI, LootSystem, zones |
| Shared types, protocol, constants | Tyrael + Leah | Item types, zone messages, quest definitions |
